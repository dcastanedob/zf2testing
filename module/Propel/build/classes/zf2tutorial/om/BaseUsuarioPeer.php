...
abstract class BaseUsuarioPeer
{
    ...
    /** the column name for the usario_password field */
    const USARIO_PASSWORD = 'usuario.usario_password';

    /** the column name for the usuario_nickname field */
    const USUARIO_NICKNAME = 'usuario.usuario_nickname';
    ...
    protected static $fieldNames = array (
        BasePeer::TYPE_PHPNAME => array ('Idusuario', 'UsuarioNombre', 'UsarioPassword', 'UsuarioNickname', ),
        BasePeer::TYPE_STUDLYPHPNAME => array ('idusuario', 'usuarioNombre', 'usarioPassword', 'usuarioNickname', ),
        BasePeer::TYPE_COLNAME => array (UsuarioPeer::IDUSUARIO, UsuarioPeer::USUARIO_NOMBRE, UsuarioPeer::USARIO_PASSWORD, UsuarioPeer::USUARIO_NICKNAME, ),
        BasePeer::TYPE_RAW_COLNAME => array ('IDUSUARIO', 'USUARIO_NOMBRE', 'USARIO_PASSWORD', 'USUARIO_NICKNAME', ),
        BasePeer::TYPE_FIELDNAME => array ('idusuario', 'usuario_nombre', 'usario_password', 'usuario_nickname', ),
    ...
    protected static $fieldKeys = array (
        BasePeer::TYPE_PHPNAME => array ('Idusuario' => 0, 'UsuarioNombre' => 1, 'UsarioPassword' => 2, 'UsuarioNickname' => 3, ),
        BasePeer::TYPE_STUDLYPHPNAME => array ('idusuario' => 0, 'usuarioNombre' => 1, 'usarioPassword' => 2, 'usuarioNickname' => 3, ),
        BasePeer::TYPE_COLNAME => array (UsuarioPeer::IDUSUARIO => 0, UsuarioPeer::USUARIO_NOMBRE => 1, UsuarioPeer::USARIO_PASSWORD => 2, UsuarioPeer::USUARIO_NICKNAME => 3, ),
        BasePeer::TYPE_RAW_COLNAME => array ('IDUSUARIO' => 0, 'USUARIO_NOMBRE' => 1, 'USARIO_PASSWORD' => 2, 'USUARIO_NICKNAME' => 3, ),
        BasePeer::TYPE_FIELDNAME => array ('idusuario' => 0, 'usuario_nombre' => 1, 'usario_password' => 2, 'usuario_nickname' => 3, ),
        BasePeer::TYPE_NUM => array (0, 1, 2, 3, )
    );
    ...
    public static function addSelectColumns(Criteria $criteria, $alias = null)
    {
        if (null === $alias) {
            ...
            $criteria->addSelectColumn(UsuarioPeer::USARIO_PASSWORD);
            $criteria->addSelectColumn(UsuarioPeer::USUARIO_NICKNAME);
        } else {
            $criteria->addSelectColumn($alias . '.idusuario');
            $criteria->addSelectColumn($alias . '.usuario_nombre');
            $criteria->addSelectColumn($alias . '.usario_password');
            $criteria->addSelectColumn($alias . '.usuario_nickname');
        }
    }
