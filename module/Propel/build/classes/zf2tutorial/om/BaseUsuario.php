...
abstract class BaseUsuario extends BaseObject implements Persistent
{
    ...
    /**
     * The value for the usario_password field.
     * @var        string
     */
    protected $usario_password;

    /**
     * The value for the usuario_nickname field.
     * @var        string
     */
    protected $usuario_nickname;
    ...
    /**
     * Get the [usario_password] column value.
     *
     * @return string
     */
    public function getUsarioPassword()
    {

        return $this->usario_password;
    }

    /**
     * Get the [usuario_nickname] column value.
     *
     * @return string
     */
    ...
    /**
     * Set the value of [usario_password] column.
     *
     * @param  string $v new value
     * @return Usuario The current object (for fluent API support)
     */
    public function setUsarioPassword($v)
    {
        if ($v !== null) {
            $v = (string) $v;
        }

        if ($this->usario_password !== $v) {
            $this->usario_password = $v;
            $this->modifiedColumns[] = UsuarioPeer::USARIO_PASSWORD;
        }
    ...
    /**
     * Set the value of [usuario_nickname] column.
     *
     * @param  string $v new value
     * @return Usuario The current object (for fluent API support)
     */
    public function setUsuarioNickname($v)
    {
        if ($v !== null) {
            $v = (string) $v;
        }

        if ($this->usuario_nickname !== $v) {
            $this->usuario_nickname = $v;
            $this->modifiedColumns[] = UsuarioPeer::USUARIO_NICKNAME;
        }
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false)
    {
        try {
            ...
            $this->usario_password = ($row[$startcol + 2] !== null) ? (string) $row[$startcol + 2] : null;
            $this->usuario_nickname = ($row[$startcol + 3] !== null) ? (string) $row[$startcol + 3] : null;
            $this->resetModified();
            ...
            return $startcol + 4; // 4 = UsuarioPeer::NUM_HYDRATE_COLUMNS.
    ...
    protected function doInsert(PropelPDO $con)
    {
        ...
        if ($this->isColumnModified(UsuarioPeer::USARIO_PASSWORD)) {
            $modifiedColumns[':p' . $index++]  = '`usario_password`';
        }
        if ($this->isColumnModified(UsuarioPeer::USUARIO_NICKNAME)) {
            $modifiedColumns[':p' . $index++]  = '`usuario_nickname`';
        }
            ...
            foreach ($modifiedColumns as $identifier => $columnName) {
                switch ($columnName) {
                    ...
                    case '`usuario_nombre`':
                        ...
                        break;
                    case '`usario_password`':
                        $stmt->bindValue($identifier, $this->usario_password, PDO::PARAM_STR);
                        break;
                    case '`usuario_nickname`':
                        $stmt->bindValue($identifier, $this->usuario_nickname, PDO::PARAM_STR);
                        break;
                }
            }
            $stmt->execute();
    ...
    public function getByPosition($pos)
    {
        switch ($pos) {
            ...
            case 1:
                ...
                break;
            case 2:
                return $this->getUsarioPassword();
                break;
            case 3:
                return $this->getUsuarioNickname();
                break;
            default:
                return null;
                break;
    ...
    public function toArray($keyType = BasePeer::TYPE_PHPNAME, $includeLazyLoadColumns = true, $alreadyDumpedObjects = array())
    {
        ...
        $result = array(
            ...
            $keys[2] => $this->getUsarioPassword(),
            $keys[3] => $this->getUsuarioNickname(),
        );
    ...
    public function setByPosition($pos, $value)
    {
        switch ($pos) {
            ...
            case 1:
                ...
                break;
            case 2:
                $this->setUsarioPassword($value);
                break;
            case 3:
                $this->setUsuarioNickname($value);
                break;
        } // switch()
    }
    ...
    public function fromArray($arr, $keyType = BasePeer::TYPE_PHPNAME)
    {
        ...
        if (array_key_exists($keys[2], $arr)) $this->setUsarioPassword($arr[$keys[2]]);
        if (array_key_exists($keys[3], $arr)) $this->setUsuarioNickname($arr[$keys[3]]);
    }
    ...
    public function buildCriteria()
    {
        ...
        if ($this->isColumnModified(UsuarioPeer::USARIO_PASSWORD)) $criteria->add(UsuarioPeer::USARIO_PASSWORD, $this->usario_password);
        if ($this->isColumnModified(UsuarioPeer::USUARIO_NICKNAME)) $criteria->add(UsuarioPeer::USUARIO_NICKNAME, $this->usuario_nickname);
    ...
    public function copyInto($copyObj, $deepCopy = false, $makeNew = true)
    {
        ...
        $copyObj->setUsarioPassword($this->getUsarioPassword());
        $copyObj->setUsuarioNickname($this->getUsuarioNickname());
        if ($makeNew) {
            $copyObj->setNew(true);
    ...
    public function clear()
    {
        ...
        $this->usario_password = null;
        $this->usuario_nickname = null;
        $this->alreadyInSave = false;
        $this->alreadyInValidation = false;
